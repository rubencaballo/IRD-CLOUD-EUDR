...
# ================= CONFIGURACIÓN =================
# CAMBIO PARA LA COLA (worker_ird.py): estas tres rutas/valores ahora se
# pueden sobreescribir por variable de entorno. Si no se define nada (por
# ejemplo cuando lo corres tú a mano en la terminal), se comporta exactamente
# igual que antes -- mismos defaults, cero cambio de comportamiento.
GEOJSON_PATH = os.environ.get(
    'IRD_GEOJSON_PATH',
    '/home/ruben/Documentos/EUDR_Expediente/EUDR_Expedientes/Poligonos Texin-Teocelo.geojson'
)
OUTPUT_BASE = os.environ.get(
    'IRD_OUTPUT_BASE',
    '/home/ruben/Documentos/EUDR_Expediente/EUDR_Expedientes/Teocelo_Texin'
)
HS_CODE = os.environ.get('IRD_HS_CODE', '090111')
